<x-layout>
    ...
    <x-section type="clean">
        <main class="flex justify-between items-center py-5">
            <div class="flex-1 text-left">
                <div class="w-4/5">
                    <h2 class="font-bold text-5xl text-gray-900 leading-tight">
    ...
    <x-section type="base">
        <div class="flex justify-center items-center flex-col py-32">
            <div class="flex justify-center flex-initial items-start pb-5">
                <div class="pr-10">
    ...
    <x-section type="clean">
        <div class="py-32">
            ...
            <div class="grid grid-cols-4 grid-rows-2 gap-x-6 gap-y-10">
    ...
    <x-section type="dark">
        <div class="flex justify-between items-center py-10">
            <div>
                <h3 class="text-left text-4xl font-extrabold text-white pb-4">Suena bien?</h3>
