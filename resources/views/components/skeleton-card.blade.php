...
<div class="skeleton-card">
    ...
    >
        <div class="flex items-center">
            ...
            <div class="flex-auto flex flex-col justify-between h-80 p-6 pr-8">
                ...
                <div class="flex flex-col h-20 w-full space-y-2">
                    <div class="flex items-center space-x-2 h-1/3">
                ...
                <div class="self-end w-1/3 h-10 bg-gray-200 rounded px-8 rounded-full py-3"></div>
            </div>
        </div>
    </article>
</div>
